      ...
      <div className="relative py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="md:col-span-2">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-white drop-shadow">AI Water Awareness</span>
              </div>
              <p className="text-cyan-100 mb-4 drop-shadow-sm">
                Raising awareness about the hidden water costs of artificial intelligence. 
                Every query matters — use AI mindfully to protect our planet's water resources.
              </p>
            ...
            <div>
              <h4 className="text-white mb-4 drop-shadow">About</h4>
              <ul className="space-y-2">
                <li>
                  <a href="#" className="text-cyan-200 hover:text-cyan-100 transition-colors drop-shadow-sm">
                    Our Mission
          ...
          <div className="border-t border-white/20 pt-8 text-center">
            <p className="text-cyan-200 drop-shadow-sm">© {currentYear} AI Water Awareness. Making conscious choices about technology and water. Every query counts.</p>
          </div>
        </div>
      </div>
    </footer>
